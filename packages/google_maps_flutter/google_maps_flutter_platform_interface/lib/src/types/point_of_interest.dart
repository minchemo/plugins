...
class PointOfInterest {
  ...
  const PointOfInterest(LatLng this.position, String this.name, String this.placeId);
  ...
  static PointOfInterest? fromJson(Object? json) {
    ...
    return PointOfInterest(LatLng.fromJson(data["position"])!, data["location"], data["location"]);
  }
